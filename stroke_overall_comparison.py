...
M1 = [Mean1[0][len(Mean1[0])-1], Mean3[0][len(Mean3[0])-1], Mean5[0][len(Mean5[0])-1]]
M2 = [Mean1_psc[0][len(Mean1_psc[0])-1], Mean3_psc[0][len(Mean3_psc[0])-1], Mean5_psc[0][len(Mean5_psc[0])-1]]
M3 = [Mean1_psc_red[0][len(Mean1_psc_red[0])-1], Mean3_psc_red[0][len(Mean3_psc_red[0])-1], Mean5_psc_red[0][len(Mean5_psc_red[0])-1]]
M4 = [Mean1_psc_cap[0][len(Mean1_psc_cap[0])-1], Mean3_psc_cap[0][len(Mean3_psc_cap[0])-1], Mean5_psc_cap[0][len(Mean5_psc_cap[0])-1]]
